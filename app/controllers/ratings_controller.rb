class RatingsController < ApplicationController
  ...
  def create
    ...
    if @rating && @rating.save
      ...
      redirect_to job_path(locale: current_locale_country, id: @job.id, success: @success)
    elsif @rating
  ...
  def rating_params
    params.require(:rating).permit(:professionalism, :quality, :value,
                                   :comments, :contractor_id)
  end
end
